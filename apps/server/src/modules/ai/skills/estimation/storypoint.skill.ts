...
export class StorypointSkill implements AISkill<any, any> {
  id = 'estimation-storypoint';
  name = 'Storypoint';
  description = 'AI Skill for storypoint';
...
Respond ONLY with a valid JSON object matching this schema:
{
  ...
  "reasoning": "Explanation"
    ...
    try {
      ...
      console.error("Failed to parse JSON for estimation-storypoint", response.content);
      throw e;
    }
  }
}
