...
export class RewriteSkill implements AISkill<any, any> {
  id = 'writing-rewrite';
  name = 'Rewrite';
  description = 'AI Skill for rewrite';
...
Respond ONLY with a valid JSON object matching this schema:
{
  "result": "The rewritten or improved text"
    ...
    try {
      ...
      console.error("Failed to parse JSON for writing-rewrite", response.content);
      throw e;
    }
  }
}
