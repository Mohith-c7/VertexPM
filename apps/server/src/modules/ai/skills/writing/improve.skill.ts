...
export class ImproveSkill implements AISkill<any, any> {
  id = 'writing-improve';
  name = 'Improve';
  description = 'AI Skill for improve';
...
Respond ONLY with a valid JSON object matching this schema:
{
  "result": "The rewritten or improved text"
    ...
    try {
      ...
      console.error("Failed to parse JSON for writing-improve", response.content);
      throw e;
    }
  }
}
