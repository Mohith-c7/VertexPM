...
export class SummarizeSkill implements AISkill<any, any> {
  id = 'writing-summarize';
  name = 'Summarize';
  description = 'AI Skill for summarize';
...
Respond ONLY with a valid JSON object matching this schema:
{
  "result": "The rewritten or improved text"
    ...
    try {
      ...
      console.error("Failed to parse JSON for writing-summarize", response.content);
      throw e;
    }
  }
}
