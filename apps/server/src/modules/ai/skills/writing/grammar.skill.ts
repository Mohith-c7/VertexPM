...
export class GrammarSkill implements AISkill<any, any> {
  id = 'writing-grammar';
  name = 'Grammar';
  description = 'AI Skill for grammar';
...
Respond ONLY with a valid JSON object matching this schema:
{
  "result": "The rewritten or improved text"
    ...
    try {
      ...
      console.error("Failed to parse JSON for writing-grammar", response.content);
      throw e;
    }
  }
}
