...
export class FeatureSkill implements AISkill<any, any> {
  id = 'generation-feature';
  name = 'Feature';
  description = 'AI Skill for feature';
...
Respond ONLY with a valid JSON object matching this schema:
{
  ...
  "description": "Description"
    ...
    try {
      ...
      console.error("Failed to parse JSON for generation-feature", response.content);
      throw e;
    }
  }
}
