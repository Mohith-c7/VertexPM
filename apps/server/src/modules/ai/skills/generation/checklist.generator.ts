...
export class ChecklistSkill implements AISkill<any, string[]> {
  id = 'generation-checklist';
  name = 'Checklist';
  description = 'AI Skill for checklist';
...
["Item 1", "Item 2"]`;
    ...
    try {
      ...
      console.error("Failed to parse JSON for generation-checklist", response.content);
      throw e;
    }
  }
}
